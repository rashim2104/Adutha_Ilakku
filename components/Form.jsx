...
export default function Form() {
  ...
  return (
    ...
    //         />
    //         {errors.DOB && (
    //           <p className="required text-sm">{errors.DOB.message}</p>
    //         )}
    ...
    //             )}
    //             {errors.GroupOther && (
    //               <p className="required text-sm">
    //                 {errors.GroupOther.message}
    //               </p>
    //             )}
    //           </>
    //         )}
    ...
    //   {isDownload !== "" && (
    //     <div>
    //       <h1 className="text-4xl font-bold mt-4">Download QR Code</h1>
    ...
    // </>
    <>
    <h1 className="font-bold text-6xl p-4 mt-6 mb-48">Form will be opened soon!</h1>
    </>
  );
}
